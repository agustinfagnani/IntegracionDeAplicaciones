...
public class CargaDatos {
	...
	Alumno alumno3 = new Alumno("Juan Perez", 123, "Su Casa", "mail@aa.com","4256575", esc1.getId());
	Alumno alumno4 = new Alumno("Juan Perez", 123, "Su Casa", "mail@aa.com","4256575", esc1.getId());
	Alumno alumno5 = new Alumno("Juan Perez", 123, "Su Casa", "mail@aa.com","4256575", esc1.getId());
	Alumno alumno6 = new Alumno("Juan Perez", 123, "Su Casa", "mail@aa.com","4256575", esc1.getId());
